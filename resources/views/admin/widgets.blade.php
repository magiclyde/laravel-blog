        ...
        <div class="row">
            <div class="col-lg-4">
                    <div class="widget-head-color-box navy-bg p-lg text-center">
                        ...
                        <img src="{{ asset('/inspiration/img/a4.jpg') }}" class="img-circle circle-border m-b-md" alt="profile">
                        <div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="ibox-content text-center">
                                <h1>Nicki Smith</h1>
                                <div class="m-b-sm">
                                        <img alt="image" class="img-circle" src="{{ asset('/inspiration/img/a8.jpg') }}">
                                </div>
...
<!-- jquery UI -->
    ...
    <script src="{{ asset('inspiration/js/plugins/touchpunch/jquery.ui.touch-punch.min.js') }}"></script>
